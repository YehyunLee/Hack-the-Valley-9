...
import Trashcam from "../../components/trashcam";
...
export default function Home() {
  ...
  const [trashcamChatEnabled, setTrashcamChatEnabled] = useState<boolean>(false);
              ...
              <div className="mt-4 rounded-3xl bg-DAF2F1 p-4 shadow-2xl" data-aos="fade-up">
                ...
                <div className="mb-4 rounded-lg bg-white p-4">
                  <p className="mb-2 text-1E635F">
                    Normal - trashcam based on topics of your interests
                  </p>
                  <p className="text-red-600">
                    Crazy - trashcam random topics and assigned arguments.
